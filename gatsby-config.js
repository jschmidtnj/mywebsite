module.exports = {
  siteMetadata: {
    ...
    description:
      "This blog / portfolio website was built with Gatsby, and Netlify CMS. It follows the JAMstack architecture by using Git as a single source of truth, and Netlify for continuous deployment, and CDN distribution."
  },
  plugins: [
